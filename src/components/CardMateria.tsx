...
export function CardMateria(props: CardMateriaProps) {
    ...
    return(
        ...
        <div>
            ...
            <h5 className={`${styles.title} mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white`}>{props.CardMateriaTitulo}</h5>
            <p className={`${styles.description} font-normal text-gray-700 dark:text-gray-400`}>{props.CardMateriaDescricao}</p>
            </a>
        </div>
